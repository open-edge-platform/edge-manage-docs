Version 2026.0 Key Performance Indicators (KPIs)
=======================================================

For 2026.0 release the following KPI goals were met that assured the quality
...
.. list-table:: Cloud Orchestrator KPIs
   ...
   * - Edge Node Onboarding and Provisioning (Edge Microvisor Toolkit)
     - 10 minutes
     - ~6 minutes ( Intel® Core™ processor)
