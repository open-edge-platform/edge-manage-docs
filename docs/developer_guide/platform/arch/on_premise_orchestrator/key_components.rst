...
1. onprem-config-installer
    ...
    - **Main Tasks**: As part of the configuration process, onprem-config-installer will install a number of tools required for the Edge Orchestrator including yq and helm. It will also configure Logical Volume Manager (LVM) for the OS and create PersistentVolume (PV).
