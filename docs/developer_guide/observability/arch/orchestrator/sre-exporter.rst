...
#. ``metrics-exporter`` collects metrics from Edge Orchestrator Observability, Edge
...
- Collecting metrics from Edge Orchestrator Observability and exporting them to the Destination SRE System by the SRE Exporter service.
...
.. list-table:: Exported Edge Orchestrator Metrics
   :header-rows: 1
