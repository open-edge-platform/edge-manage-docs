...
Operators to monitor the telemetry from the host level of the Edge Node,
including provisioning. Refer to :doc:`../edgenode/hosts` for more details.

Key components of the observability stack that allow collection, storage and
...
.. note::
   ...
   multitenacy in observability is hanlded.

.. image:: ./images/diagram_edge_node-obs_stack.svg
...
* ``edgenode-observability`` - provides core services for the observability
