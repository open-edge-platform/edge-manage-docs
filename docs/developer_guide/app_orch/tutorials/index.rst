...
This tutorial will follow the 6-step approach outlined in the :doc:`../../application_developer_workflow/index`.

The User Guide :doc:`/user_guide/package_software/quick_start_guide` gives a simpler overview of just the
steps needed to bundle and deploy an application using Application Orchestration.

The code examples given in this section are available at `<https://github.com/open-edge-platform/app-orch-catalog/tree/main/app-orch-tutorials>`_.
