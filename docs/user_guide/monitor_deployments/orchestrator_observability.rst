...
.. note::
   To access the dashboard, the user must belong to the `Service-Admin-Group`
   group which grants these roles:
...
The following is an example of the Audit Log for REST API calls:
