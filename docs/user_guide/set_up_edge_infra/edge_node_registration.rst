...
#. Bulk import of edge devices through the Bulk Import tool
...
Once a connecting edge node reports a UUID or serial number that matches the registered information, the node will be onboarded and provisioning will start.
