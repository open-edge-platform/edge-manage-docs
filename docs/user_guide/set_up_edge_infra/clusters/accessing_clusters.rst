...
You can download or copy the Kubeconfig file to access clusters deployed on the edge node.
To do so, go to the **Cluster List** page, select the cluster, and in the **Actions** column, click **Download Kubeconfig File**.
