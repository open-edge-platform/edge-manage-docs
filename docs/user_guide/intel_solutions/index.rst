...
6. `Open Edge Intel Platform Software Catalog - Smart Parking Sample Application v1.3.0 <https://github.com/open-edge-platform/edge-ai-suites/blob/release-2025.2.0/metro-ai-suite/metro-vision-ai-app-recipe/smart-intersection/docs/user-guide/how-to-deploy-with-edge-orchestrator.md>`__.
...
8. `Open Edge Intel Platform Software Catalog - Chat Q&A Sample Application Sample Application v1.2.4 <https://github.com/open-edge-platform/edge-ai-libraries/blob/main/sample-applications/chat-question-and-answer/docs/user-guide/deploy-with-edge-orchestrator.md>`__.
