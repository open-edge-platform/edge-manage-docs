...
2. `Open Edge Intel Platform Software Catalog - Image-Based Video Search Sample Application v1.0.0  <https://docs.openedgeplatform.intel.com/edge-ai-suites/image-based-video-search/hotfix-release-1.0.0-emf-metro-apps/user-guide/Overview.html>`__.
