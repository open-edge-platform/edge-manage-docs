...
5. `Open Edge Intel Platform Software Catalog - Image-Based Video Search Sample Application v1.1.0  <https://github.com/open-edge-platform/edge-ai-suites/blob/release-2025.2.0/metro-ai-suite/image-based-video-search/docs/user-guide/how-to-deploy-with-edge-orchestrator.md>`__.
6. `Open Edge Intel Platform Software Catalog - Smart Parking Sample Application v1.3.0 <https://github.com/open-edge-platform/edge-ai-suites/blob/release-2025.2.0/metro-ai-suite/metro-vision-ai-app-recipe/smart-parking/docs/user-guide/how-to-deploy-with-edge-orchestrator.md>`__.
7. `Open Edge Intel Platform Software Catalog - Loitering Detection Sample Application v1.3.0 <https://github.com/open-edge-platform/edge-ai-suites/blob/release-2025.2.0/metro-ai-suite/metro-vision-ai-app-recipe/loitering-detection/docs/user-guide/how-to-deploy-with-edge-orchestrator.md>`__.
8. `Open Edge Intel Platform Software Catalog - Chat Q&A Sample Application Sample Application v2.0.1 <https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2025.2.0/sample-applications/chat-question-and-answer/docs/user-guide/deploy-with-edge-orchestrator.md>`__.
