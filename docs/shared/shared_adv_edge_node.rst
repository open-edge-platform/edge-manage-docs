...
* firewallCfgAllow - Set the environment firewall to Allow. Retain the existing ports, ipVer and protocol configurations.
  Use a blank value (“”) or remove the elements if not required for firewall configuration.
